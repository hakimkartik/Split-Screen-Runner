...
public class SpeedControllerTutorial2 : MonoBehaviour
{
    private CarMoveTutorial2 carLeftMove;

    private CarMoveTutorial2 carRightMove;
    ...
    void Start()
    {
        ...
        if (carLeft != null)
        {
            carLeftMove = carLeft.GetComponent<CarMoveTutorial2>();
            if (carLeftMove == null)
            {
        ...
        if (carRight != null)
        {
            carRightMove = carRight.GetComponent<CarMoveTutorial2>();
    ...
    private IEnumerator SlowDownCoroutine(CarMoveTutorial2 carMove, float duration)
    {
